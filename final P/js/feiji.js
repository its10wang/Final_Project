window.onload=function(){
		...
		var Game = {
				...
				'init':function(){
					setTimeout(function(){
						...
						var oTitle = Game.ctE('h3');
							oTitle.innerHTML='Game-fly';		
						var oDiv = Game.ctE('div');
							oDiv.innerHTML = '<p class="ac">simple</p><p class="ac">commonly</p><p class="ac">difficulty</p>';
				...
				'start' : function(ev){
					ev = ev||event;
					var s =0;//s-bgspeed
					var t =0;//t-bot-sc-speed
					var c = 0;//c-bot-speed
					var d = 0;//-dfly-sc-speed
					function bg(i){
				...
				'over' : function(){
					...
					oSpan.innerHTML='Score:'+Game.fenshu;
